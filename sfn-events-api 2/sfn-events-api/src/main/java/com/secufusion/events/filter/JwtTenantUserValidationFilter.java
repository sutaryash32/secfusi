package com.secufusion.events.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.secufusion.events.dto.LoggedInUserDetailsBean;
import com.secufusion.events.entity.Scopes;
...
import com.secufusion.events.repository.ApiFlagRepository;
import com.secufusion.events.repository.TenantApiMappingRepository;
...
public class JwtTenantUserValidationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            Optional<User> userOpt = userRepository.findByEmailAndTenant_TenantID(userFromRequest.getEmail(), tenantId);
            if (userOpt.isEmpty()) {
