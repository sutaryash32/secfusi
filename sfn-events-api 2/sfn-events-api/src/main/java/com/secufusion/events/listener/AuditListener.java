// java
package com.secufusion.events.listener;

import com.secufusion.events.entity.Auditable;
...
public class AuditListener {
    ...
    private String getCurrentUsername() {
        try {
            ...
            if (jwtUtl != null) {
                // Only use JWT claim extraction (in-memory).
                // NEVER call JPA repository methods here — they trigger auto-flush
                // which re-enters @PreUpdate and causes infinite recursion.
