...
//            );
    ...
    private void validateUserFields(Tenant tenant, UsersDto dto, String excludeUserId) {
        ...
        // PHONE - uniqueness check removed, phone number is optional and non-unique
        if (dto.getPhoneNumber() != null && !dto.getPhoneNumber().isBlank()) {
            log.debug("Phone number provided, uniqueness validation disabled. phone={}",
                    maskPhone(dto.getPhoneNumber()));
        }
